package com.inventine.controller.dashboard.forumTopic;
...
@WebServlet(name = "ForumTopicCreateServlet", value = "/dashboard/forumTopic/create")
public class ForumTopicCreateServlet extends HttpServlet {
    @Override
