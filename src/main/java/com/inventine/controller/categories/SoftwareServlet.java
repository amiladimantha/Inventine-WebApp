...
@WebServlet(name = "SoftwareServlet", value = "/categories/software")
public class
SoftwareServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/categories/software.jsp").forward(request, response);
    }
