...
@WebServlet(name = "DesignServlet", value = "/categories/design")
public class DesignServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String condition = "category='design';";
        ...
        request.getRequestDispatcher("/WEB-INF/categories/design.jsp").forward(request, response);
    }
