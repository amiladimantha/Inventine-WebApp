...
@WebServlet(name = "TechServlet", value = "/categories/technology")
public class TechnologyServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String condition = "category='technology';";
        ...
        request.getRequestDispatcher("/WEB-INF/categories/technology.jsp").forward(request, response);
    }
