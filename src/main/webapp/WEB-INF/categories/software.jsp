...
<div class="content">
    ...
    <div class="container">
        <div class="column-1">
            <h1>Software</h1>
            <span class="paragraph">"Biology is the most powerful technology ever created. DNA is software, protein are hardware, cells are factories." <br>"Computers themselves, and software yet to be developed, will revolutionize the way we learn."</span>
