...
<div class="content">
  ...
  <div class="container">
    <div class="column-1">
      <h1>Design</h1>
      <span class="paragraph">"Have no fear of perfection -- you'll never reach it." <br>"Design is intelligence made visible." <br> "Design adds value faster than it adds costs."</span>
