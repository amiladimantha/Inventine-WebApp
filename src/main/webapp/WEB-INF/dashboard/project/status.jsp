        ...
        <div class="form">
            ...
            <div class="details">
                ...
                <div class="input-box">
                    ...
                    <input type="text" name="imageId" id="imageId" value="<% out.print(project.getImageId());%>" disabled>
...
<%--                </div>--%>
                ...
                <div class="input-box">
                    <span class="details">Status (Active/Blocked/Deleted/Undecided)</span>
                    <select class="status" name="status" id="status" required>
                        <option hidden> <%out.print(project.getStatus());%></option>
                        <option value="Active">A</option>
                        <option value="Blocked">B</option>
                        <option value="Deleted">D</option>
                        <option value="Undecided">U</option>
                    </select>
                    <span class="error" aria-live="polite" style="display: none;" >Select a status</span>
                </div>
